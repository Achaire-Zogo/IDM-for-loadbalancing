...
/**
 * This is the item provider adapter for a {@link loadbalancer.Server} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LoadbalancerPackage.Literals.SERVER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addHostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_host_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_host_feature", "_UI_Server_type"),
				 LoadbalancerPackage.Literals.SERVER__HOST,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_port_feature", "_UI_Server_type"),
	...
	protected void addWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_weight_feature", "_UI_Server_type"),
	...
	protected void addMaxConnectionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_maxConnections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_maxConnections_feature", "_UI_Server_type"),
				 LoadbalancerPackage.Literals.SERVER__MAX_CONNECTIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addEnabledPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_enabled_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_enabled_feature", "_UI_Server_type"),
				 LoadbalancerPackage.Literals.SERVER__ENABLED,
				 true,
				 false,
				 false,
