...
/**
 * This is the item provider adapter for a {@link loadbalancer.Alert} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlertItemProvider 
	...
	protected void addMetricPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alert_metric_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alert_metric_feature", "_UI_Alert_type"),
				 LoadbalancerPackage.Literals.ALERT__METRIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addThresholdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alert_threshold_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alert_threshold_feature", "_UI_Alert_type"),
				 LoadbalancerPackage.Literals.ALERT__THRESHOLD,
				 true,
				 false,
				 false,
