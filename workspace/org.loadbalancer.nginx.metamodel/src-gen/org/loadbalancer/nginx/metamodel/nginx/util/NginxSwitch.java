 ...
 * @generated
 */
public class NginxSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case NginxPackage.NGINX_CONFIG: {
			NginxConfig nginxConfig = (NginxConfig) theEObject;
			T result = caseNginxConfig(nginxConfig);
			if (result == null)
		...
		case NginxPackage.UPSTREAM_SERVER: {
			UpstreamServer upstreamServer = (UpstreamServer) theEObject;
			T result = caseUpstreamServer(upstreamServer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case NginxPackage.SERVER_BLOCK: {
			ServerBlock serverBlock = (ServerBlock) theEObject;
			T result = caseServerBlock(serverBlock);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseNginxConfig(NginxConfig object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Upstream Server</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Upstream Server</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUpstreamServer(UpstreamServer object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Server Block</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Server Block</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServerBlock(ServerBlock object) {
		return null;
	}
