...
/**
 * This is the item provider adapter for a {@link org.loadbalancer.nginx.metamodel.nginx.Upstream} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpstreamItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Upstream_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Upstream_name_feature",
								"_UI_Upstream_type"),
						NginxPackage.Literals.UPSTREAM__NAME, true, false, false,
	...
	protected void addAlgorithmPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Upstream_algorithm_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Upstream_algorithm_feature",
								"_UI_Upstream_type"),
						NginxPackage.Literals.UPSTREAM__ALGORITHM, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NginxPackage.Literals.UPSTREAM__SERVERS);
		}
	...
	public String getText(Object object) {
		String label = ((Upstream) object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(NginxPackage.Literals.UPSTREAM__SERVERS,
				NginxFactory.eINSTANCE.createUpstreamServer()));
	}
