 ...
 * <!-- end-user-doc -->
 * @see org.loadbalancer.dsl.loadBalancer.LoadBalancerPackage#getMetric()
 * @model
 * @generated
 */
public enum Metric implements Enumerator
{
   ...
   * @ordered
   */
  REQUEST_COUNT(3, "REQUEST_COUNT", "REQUEST_COUNT"),
   ...
   * @ordered
   */
  public static final int REQUEST_COUNT_VALUE = 3;
