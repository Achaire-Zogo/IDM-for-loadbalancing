...
\centering
\begin{tikzpicture}[
  class/.style={rectangle, draw, fill=white, minimum width=4cm, minimum height=1.5cm, text centered, font=\small},
  enum/.style={rectangle, draw, fill=gray!10, minimum width=3cm, minimum height=1.2cm, text centered, font=\small},
